...
def lambda_handler(event, context):
    ...
    customheader1value = os.environ['customheader1value']
    customheader2value = os.environ['customheader2value']

    if (event['headers']['customheader1'] == customheader1value and 
        event['headers']['customheader2'] == customheader2value):
        principalId = 'AuthorizedApp'
    else:
...
class AuthPolicy(object):
    ...
    def build(self):
        ...
        print("API policy added: %s" % (policy))
        return policy